...
WGR_TX_FEE = 0.001
WGR_WALLET_ADDRESS = "TEYNdtsUy6k2zG6fY5mAo4jineGP8oLpNR"
...
def get_utxo_list(node):
    ...
    for utxo in node.listunspent():
        if utxo['address'] == WGR_WALLET_ADDRESS:
